...
class Config(object):
    ...
    START_IMG = os.environ.get("START_IMG", "https://telegra.ph/file/9381a140aafbb75177300.jpg")
    CMD_IMG = os.environ.get("CMD_IMG", "https://telegra.ph/file/9381a140aafbb75177300.jpg")
